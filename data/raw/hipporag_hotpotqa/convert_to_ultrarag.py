#!/usr/bin/env python3
"""
Convert HippoRAG HotpotQA dataset to UltraRAG format
"""
...
def convert_questions(input_file, output_file):
    """Convert HotpotQA question data to UltraRAG format"""
...
def convert_corpus(input_file, output_file):
    """Convert HotpotQA corpus data to UltraRAG format"""
...
def main():
    ...
    # Input files
    questions_input = base_dir / "hotpotqa_with_index.json"
    corpus_input = base_dir / "hotpotqa_corpus_with_index.json"
    
    # Output files (save to /data directory)
    data_dir = base_dir.parent.parent  # Go up to /data directory
    questions_output = data_dir / "hotpotqa_questions.jsonl"
    corpus_output = data_dir / "hotpotqa_corpus.jsonl"
